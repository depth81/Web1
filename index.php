    ...
    <main>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <!-- Preguntar si algo existe? se le hizo click al botón de envío? 
                isset (presionaron?) / $_POST (a quién?). Traer lo que hay por dentro o el valor que escribió el usuario -->
